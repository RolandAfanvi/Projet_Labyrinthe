...
def dijkstra_pred(G,s):
 ...
 ###############################################
 #decommenter les print pour avoir l affigage en console

grille=Grille(6,6)

                # TEST DE LA PARTIE B (AFFICHAGE DU GRAPHE EN CONSOLE)
                # LES CELLULES AVEC SES DEUX VOISINS

Q=Graphe(grille)
#print(Q)

                # TEST DE LA PARTIE C (AFFICHAGE DES CHEMINS LES PLUS COURT DEPUIS
                # LA CELLULE DE DEPART VERS LES AUTRES)

deb=(0,grille.getLargeur()-1)
B=dijkstra(Q,deb) # retourne un dictionaire avec les distances minimale vers chaque cellule qui les clé
#print(B)

                #TEST DE LA PARTIE D ET E 
                #AFFICHAGE A LA CONSOLE DU CHEMIN LE PLUS COURT DEUIS LA CELLULE DE
                #DEPART VERS LA CELLULE D ARRIVÉ (longueurde la grille,0) 
